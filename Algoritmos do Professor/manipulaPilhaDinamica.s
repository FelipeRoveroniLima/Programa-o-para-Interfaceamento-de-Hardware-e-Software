.section .data
	...
	# total de 84 bytes: nome (44), RA (8), sexo (4), curso (24, sendo 1 para '\0') e próximo (4).
...
_start:
	...
	# A funcao abaixo espera que o endereco inicial da memoria alocada esteja em %edi. 
	# Entao, ela le nome, RA, sexo e curso e coloca na respectiva memoria
...
le_dados:
	...
	#addl 	$4, %esp
	popl 	%edi 		# recupera %edi
	addl 	$24, %edi 	# avanca para o proximo campo		# X2

	movl 	$NULL, (%edi)
	subl 	$80,%edi 	# deixa %edi tal como estava noinicio
	RET
